...
// The three prompts live in components/feedback-prompt.js rather than here:
// this module reaches for the database, so a client component cannot import
// from it. What the server owns is the shape — the three keys below.
const MAX_LEN = 4000;
