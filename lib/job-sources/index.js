...
// Two sources, both with real server-side location targeting worldwide
// (Europe + Americas): JSearch rides Google's job index (LinkedIn, Indeed,
// Glassdoor, company sites) and Adzuna has per-country endpoints. The
// locally-filtered boards (Greenhouse/Lever/Remotive/GitHub lists) were
// the residual location-noise source and were removed deliberately —
// precision over volume, and every junk job was a paid screening call.
const adapters = [searchJSearch, searchAdzuna];
