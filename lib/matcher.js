...
// The match verdict used to be produced HERE, by asking Claude for a score
// directly. That path is gone: lib/matching/ now extracts facts from the
// posting (lib/matching/extract.ts) and computes the score deterministically
// (lib/matching/score.ts). Do not reintroduce a model-authored score.
